...
--
-- profile:     truck (mode: truck)
-- spec chain:  truck.yaml
-- fingerprint: aeed21b5c465894d
-- summary:     40 t articulated HGV at EU maximum dimensions.
--
...
local PROFILE_NAME = "truck"
local DEFAULT_SPEED = 25
local GLOBAL_FACTOR = 1
local MAX_LEGAL_SPEED = 90
...
local access_hierarchy = { "hgv", "goods", "motor_vehicle", "vehicle", "access" }
local access_allow = {
  ["yes"] = true,
  ["designated"] = true,
  ["permissive"] = true,
...
local FERRY_FACTOR = 0.25
local TOLL_AVOID = false
local TOLL_FACTOR = 0.7143
