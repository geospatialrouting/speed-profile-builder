...
--
-- profile:     van-urban (mode: van)
-- spec chain:  van-urban.yaml <- car.yaml
-- fingerprint: f8034c7e0f5b578e
-- summary:     3.5 t urban delivery van with destination access and kerbside dwell.
--
...
local PROFILE_NAME = "van-urban"
local DEFAULT_SPEED = 24
local GLOBAL_FACTOR = 0.92
local MAX_LEGAL_SPEED = 110
