...
--
-- profile:     cargo-bike (mode: bicycle)
-- spec chain:  cargo-bike.yaml
-- fingerprint: 35b3c2f259a2d5f5
-- summary:     Electrically assisted cargo bike, 1.0 m wide, cannot be carried.
--
...
--       passable with no penalty: bollard, gate, lift_gate.

api_version = 4

local PROFILE_NAME = "cargo-bike"
local DEFAULT_SPEED = 14
local GLOBAL_FACTOR = 1
local MAX_LEGAL_SPEED = 25
...
local access_hierarchy = { "cargo_bike", "bicycle", "vehicle", "access" }
local access_allow = {
  ["yes"] = true,
  ["designated"] = true,
  ["permissive"] = true,
